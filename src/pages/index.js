...
export default () => (
  <Layout>
    ...
    <div className="row">
      <div className="col-6">
        <h3><i className="fas fa-file-import"/> Import your license keys</h3>
      ...
      <div className="col-6">
        <h3><i className="fas fa-cog" />Generate license keys</h3>
      ...
      <div className="col-6">
        <h3><i className="fas fa-truck"/>Automatic delivery</h3>
      ...
      <div className="col-6">
        <h3><i className="fas fa-lock"/>Encryption</h3>
      ...
      <div className="col-6">
        <h3><i className="fas fa-store"/>WooCommerce Integration</h3>
