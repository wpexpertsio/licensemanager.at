        ...
        <div className="row">
          <div className="col-12">
            ...
            <ul>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                  refers to License Manager for WooCommerce.</p>
              </li>
              ...
              <li><strong>Website</strong> refers to License Manager for WooCommerce, accessible from www.licensemanager.at</li>
            ...
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer or
              mobile device when You go offline, while Session Cookies are deleted as soon as You close your web browser.</p>
            ...
            <ul>
              ...
              <li><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent
                forms of electronic communication, such as a mobile application's push notifications regarding updates or
            ...
            <ul>
              <li>By email: <a href="mailto:privacy@licensemanager.at">privacy@licensemanager.at</a></li>
            </ul>
